      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	...
          	<div class="row mt">
                ...
                Note:: B.V may increase or decrease on montly basisjj.<br>
		<form method="get"><input type="number" name="d_id" class="form-control"><input type="submit"></form>	
                <?php
		...
		{ $dcd=$_GET[d_id];
		echo '<button class="btn-clear-g" onclick="window.history.back()">Go Back</button><h5><i class="fa fa-angle-right"></i>'.$dcd.'</h5><br>';
				...
				{
				?>
				<form method="get"><input type="number" name="d_id"><input type="submit"></form>
          		<p><table class="table table-hover table-bordered table-striped"><tr><th>name</th><th>their purchase B.V</th><th>B.V</th></tr>
                <?php
