...
<body>
    ...
    echo '<table class="table table-bordered table-striped table-condensed">
                <tr><th width="310" height="50">Product Name</th><th width="75">Rate</th><th width="90">B.V</th></tr>';
    
	while ($p=mysql_fetch_assoc($result))
{
	?>
    <tr><td><?php echo $p[p_name];?></td><td>&#8377;&nbsp;&nbsp;<?php echo $p[p_mrp];?></td><td>B.V&nbsp;&nbsp;<?php echo $p[p_bv];?></td></tr>
    <?php }
	}
