	...
	mysql_query("delete from t") or die ("not deleted");
	  ...
	  mysql_query("delete from t1") or die ("not deleted");
	  	...
	  	$w = "select sum(bv) as total_bv from bill where status='c'";
	   	$rest = mysql_query($w) or die ("query not executed1");
...
$w = "select sum(money) as total_bv from company_spend";
	   	$rest = mysql_query($w) or die ("query not executed2");
	if (mysql_num_rows($rest)>0)
	{
        while ($row2 = mysql_fetch_assoc($rest))
		{  
	...
	$pr=$total_profit*5/100;
	$rf=$total_profit-$pr;
?>
                <tr><th>Total B.V</th><th></th><th><?php echo $total_amt;?></th></tr>
               <tr> <th>Distributed Amount</th><th></th><th><?php echo $sdd+$rf;?></th></tr>
               <tr> <th>Left Amount</th><th></th><th><?php $et=$pr+alter_bal($_SESSION[id]); echo $et;?></th></tr>
            ...
            <tr><th><h3>Your Profit</h3></th><th><?php echo $et;?>*<?php echo $per;?>/100</th><th><h3><?php echo $et*$per/100?></h3></th></tr>
                   </table>
                </p>
				</div>
          		</div>
