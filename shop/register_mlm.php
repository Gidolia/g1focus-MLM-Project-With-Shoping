...
<?php include "include/header.php";?>
		  	  ...
		  	  <form action="process_register.php" method="post" name="myForm" onsubmit="return validateForm()">
                 ...
                 <h4>Application form to become a distributer</h4>
					...
					<div class="mation">
                        ...
                        <span>Proposer No : <label>*</label></span><input type="text" name="p_no" required onKeyUp="showUsert(this.value)"  autofocus>
                        <span>Proposer Name :<label></label></span><input type="text" name="p_name" id="p_name" readonly>
                        <span>Proposer Address :<label></label></span><input type="text" name="p_addreass" id="p_addreass" readonly>
                        <br>
                        <span>Sponsor No : <label>*</label></span><input type="text" name="s_no" required onKeyUp="showUser(this.value)">
                        <span>Sponsor Name :<label></label></span><input type="text" id="s_name" name="s_name" readonly>
	...
	margin: 0.5em 0;">
				...
				<option value="West Bengal">West Bengal</option>
                        ...
                        <span>City :<label>*</label></span><input type="text" name="city" required>
                        ...
                        <span>Email Address :</span> <input type="email" name="email" style="border: 1px solid #999;
	outline-color:#FF5B36;
	width: 85%;
	font-size: 1em;
	padding: 0.5em;
