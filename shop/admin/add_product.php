...
<form method="post" enctype="multipart/form-data">
        ...
        elseif(move_uploaded_file($_FILES["p_main_pic"]["tmp_name"], "../product_image/".$_POST['p_name'].".jpg"))
		{
            echo "Stored in: " . "../product_image/".$fileName;
					...
					mysql_query("INSERT INTO `shop_bill` (`p_id`, `date`, `unit`, `lot_price`, `per_price`, `expiry_date`, `bill_id`, `e_id`, `shop_id`) VALUES ('$p_id', '$o_date', '$_POST[unit]', '$_POST[lot_price]', '$per', '$_POST[expiry]','$_POST[bill_no]','$_SESSION[e_id]','$_POST[shop_id]')")or die("problem in shop_bill database");
