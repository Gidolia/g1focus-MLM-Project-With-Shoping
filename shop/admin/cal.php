...
$grand_totalt=0;
$sel1=mysql_query("select d_id,d_name from distributor") or die("value not selected1");
while($fet1=mysql_fetch_assoc($sel1))
{	$et=0;
	$et=alter_bal($fet1[d_id]);
 $grand_totalt=$grand_totalt+$et;?>
 <tr><td><?php echo $fet1[d_name];?></td><td><?php echo $fet1[d_id];?></td><td><?php echo find_under_bv($fet1[d_id]);?></td><td><?php echo $et;?></td></tr>
