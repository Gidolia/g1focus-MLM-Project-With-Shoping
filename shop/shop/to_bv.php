...
{
	if($pert>=100 and $pert<=149){$avv=10;}
	elseif($pert>=150 and $pert<=299){$avv=15;}
	elseif($pert>=300 and $pert<=624){$avv=20;}
	elseif($pert>=625 and $pert<=1249){$avv=25;}
	elseif($pert>=1250 and $pert<=2499){$avv=30;}
	elseif($pert>=2500 and $pert<=4999){$avv=35;}
	elseif($pert>=5000 and $pert<=9999){$avv=40;}
	elseif($pert>=10000 and $pert<=19999){$avv=45;}
	elseif($pert>=20000 and $pert<=39999){$avv=49;}
	elseif($pert>=40000 and $pert<=69999){$avv=53;}
	elseif($pert>=70000 and $pert<=114999){$avv=57;}
	elseif($pert>=115000 and $pert<=169999){$avv=61;}
	elseif($pert>=170000 and $pert<=259999){$avv=65;}
	elseif($pert>=260000 and $pert<=349999){$avv=69;}
	elseif($pert>=350000){$avv=72;}
