...
if(isset($_POST[update_product]))
{
	...
	mysql_query("INSERT INTO `shop_bill` (`p_id`, `date`, `unit`, `lot_price`, `per_price`, `expiry_date`, `bill_id`, `shop_id`) VALUES ('$_POST[p_id]', '$o_date', '$_POST[qty]', '$_POST[lot_price]', '$per', '$_POST[expiry]','$_POST[bill_no]','$_POST[shop_id]')")or die("problem in shop_bill database");
