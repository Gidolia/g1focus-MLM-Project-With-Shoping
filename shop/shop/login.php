...
{
$q="SELECT * FROM `employee` WHERE shop_id='$_POST[id]' and password='$_POST[password]'and e_id='$_POST[e_id]'";
$res=mysql_query($q) or die("not selected");
$c=mysql_num_rows($res);
if($c!=0)
{
$_SESSION["shop_id"]=$_POST["id"];
$_SESSION["e_id"]=$_POST["e_id"];
$_SESSION["shop_password"]=$_POST["password"];
