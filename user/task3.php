    ...
    interval = setInterval(function() {
      ...
      elem.style.width = width + '%'; 
        ...
        countdownElement.firstChild.data = '';
            ...
            var result = '<a href="task4.php?ses=<?php echo $a;?>" class="btn btn-primary">Next</a>';
...
<?php include_once("../../analyticstracking.php") ?>
          	...
          	<div class="row mt">
          		<div class="col-lg-12">
          		<h3><i class="fa fa-angle-right"></i>Assignment Completing 2/10</h3>
          		<?php $_SESSION[t2]='1';?>
                  <div class="form-panel" style="white-space:nowrap;">
                  <br>&nbsp;<br><br>&nbsp; <br>&nbsp;<?php include_once("ad.php") ?><br>&nbsp;
