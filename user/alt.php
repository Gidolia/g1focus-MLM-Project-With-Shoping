      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	...
          	<div class="row mt">
                ...
                <tr><th>Own B.V</th><th></th><th><?php echo $o_bv;?></th><th></th><th></th></tr>
                <?php
$result = mysql_query('SELECT d_id,sponsor_no FROM distributor WHERE sponsor_no='.$_SESSION[id]);
		...
		?>
                	<tr><th><a href="bv.php?d_id=<?php echo $row[d_id];?>"><?php echo "&nbsp;".$row[d_id];?></a></th><th></th><th><?php echo $rtyo;?></th><th><?php echo slab_selection($rtyo)."%";?>     </th><th>-<?php echo $rtyo*slab_selection($rtyo)/100;?></th></tr>
                    
       <?php }
       $resultr=mysql_query("SELECT count(d_id) as total from distributor where proposer_no=".$_SESSION[id]." and new='y'");
	  ...
	  ?>
        <tr><th>Person You Joined This Month</th><td><?php echo $datar['total'];?></td><td><?php echo $o;?></td><th><?php echo $datar['total']." x 10";?></th><th><?php echo $rtyb;?></th></tr>
