...
$queryAll = $db->query("SELECT COUNT(*) as num_rows FROM post WHERE id < ".$lastID." ORDER BY id DESC");
$rowAll = $queryAll->fetch_assoc();
$allNumRows = $rowAll['num_rows'];

//Get rows by limit except already displayed
$query = $db->query("SELECT * FROM post WHERE id < ".$lastID." ORDER BY id DESC LIMIT ".$showLimit);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				elseif($row[type]=='2'){
				$querys = $db->query("SELECT * FROM post WHERE id='$postID'");
...
if($querys->num_rows > 0){
	...
	elseif($rows[type]=='3'){$type=$rows['written'];}
	else{ $type="sorry somthing went wrong with post";}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      <div>
	<?php $res=mysql_query("SELECT * FROM `post_like` WHERE `post_id`='$row[id]';")or die("sorry some error occour");
