...
<div class="container" style="auto;">
	<h1>G1focus Downline Tree</h1>
	<table class="table table-bordered">
		<thead>
        
		</thead>
		<tbody>
<tr><td><div class="tt" data-tt-id="<?php  include "../config.php"; echo $_SESSION[id];?>" data-tt-parent=""><?php  echo $_SESSION[id];?></div></td></tr>
 <?php
...
{ ?>
	...
	<tr><td><div class="tt" data-tt-id="<?php echo $fet1[d_id];?>" data-tt-parent="<?php echo $tr;?>"><?php echo $fet1[d_name]."(".$fet1[d_id].")";?></div></td></tr>
	<?php
	printtree($fet1[d_id]);
}
}
