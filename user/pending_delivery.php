      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	...
          	<div class="row mt">
                ...
                <?php 
$qu="SELECT * FROM bill WHERE status='w' and d_id=".$_SESSION[id];
...
while($fetch=mysql_fetch_assoc($query))
{
	?>
                		   ...
                		   <tr>
                                  ...
                                  <td><a href="bill_info.php?bill_id=<?php echo $fetch[bill_id];?>"><?php echo $fetch[bill_id];?></a></td>
               ...
               <?php }?>
                               <?php 
$qu="SELECT * FROM bill WHERE status='p' and d_id=".$_SESSION[id];
$query=mysql_query($qu);
while($fetch=mysql_fetch_assoc($query))
{?>
               ...
               <?php }?>
                               <?php 
$qu="SELECT * FROM bill WHERE status='c' and d_id=".$_SESSION[id];
$query=mysql_query($qu);
while($fetch=mysql_fetch_assoc($query))
{?>
               ...
               <?php $rtf=$rtf+$fetch[price];
               $rtg=$rtg+$fetch[bv]; }?>
<tr><th>Total</th><th></th><th></th><th>&#8377;&nbsp;<?php echo $rtf;?></th><th>B.V <?php echo $rtg;?></th><th></th><th></th></tr>
</table> </p></div>
          		</div>
          	</div>
