      ...
      elem.style.width = width + '%'; 
        ...
        countdownElement.firstChild.data = '';
            downloadButton.style.display = 'block';
             var result = '<a href="task9.php?ses=<?php echo $a;?>" class="btn btn-primary">Next</a>';
...
<?php include_once("../../analyticstracking.php") ?>
          	...
          	<div class="row mt">
          		<div class="col-lg-12">
          		<h3><i class="fa fa-angle-right"></i>Assignment Completing 7/10</h3>
