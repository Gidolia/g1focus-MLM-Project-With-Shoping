    ...
    interval = setInterval(function() {
      ...
      elem.style.width = width + '%'; 
        ...
        countdownElement.firstChild.data = '';
            ...
            var result = '<a href="iframe.php" target="_parent" class="btn btn-primary">Next</a>';
...
<?php include_once("../../analyticstracking.php") ?>
          	...
          	<div class="row mt">
          		<div class="col-lg-12">
          		<h3><i class="fa fa-angle-right"></i>Assignment Completing 9/10</h3>
