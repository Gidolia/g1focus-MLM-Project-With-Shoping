...
window.onload = function() {
    ...
    interval = setInterval(function() {
      ...
      elem.style.width = width + '%'; 
        ...
        countdownElement.firstChild.data = '';
            ...
            var result = '<a href="task10.php?ses=<?php echo $a;?>" class="btn btn-primary">Next</a>';
  ...
  <body><?php include_once("../../analyticstracking.php") ?>
          	...
          	<div class="row mt">
          		<div class="col-lg-12">
          		<h3><i class="fa fa-angle-right"></i>Assignment Completing 8/10</h3>
                  <div class="form-panel" style="white-space:nowrap;">
                  <br>&nbsp;<br> <?php include "ad.php"; ?><br>&nbsp;<br>&nbsp;<br>&nbsp;
