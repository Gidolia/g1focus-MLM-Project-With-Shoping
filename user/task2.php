...
window.onload = function() {
    ...
    interval = setInterval(function() {
      ...
      elem.style.width = width + '%'; 
        ...
        countdownElement.firstChild.data = '';
            ...
            var result = '<a href="task3.php?ses=<?php echo $a;?>" class="btn btn-primary">Next</a>';
  ...
  <?php include_once("../../analyticstracking.php") ?>
          	...
          	<div class="row mt">
          		<div class="col-lg-12">
          		<h3><i class="fa fa-angle-right"></i>Assignment Completing 1/10</h3>
          		<?php $_SESSION[t1]='1';?>
