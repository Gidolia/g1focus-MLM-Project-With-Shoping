...
<div id="apDiv1"><a href="../user" class="btn btn-primary btn-md">Login</a>  <a href="form.php" class="btn btn-primary btn-md">Another Joinning</a>  <a href="../shop" class="btn btn-primary btn-md">Go to Shop</a></div>
<div id="apDiv2">
...
{echo "You are register<br>
		...
		Note:: Wrote down Your distributor id carefully";}
		  ...
		  You Are Sucessfully Register your payment received sucessfully<br>
Your Login Id(<font size="+2"><?php echo $_GET[d_id];?></font>)<br>
